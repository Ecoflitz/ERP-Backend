  ...
  static async search(searchQuery, currentUser, organizationId, globalAccess) {
    try {
      ...
      const tableColumns = {
        ...
        human_resources: ['employee_name', 'shift'],

        inventory: ['product_name'],

        machinery: ['machine_name', 'maintenance_schedule'],

        quality_control: ['check_name'],

        raw_materials: ['name'],

        suppliers: ['supplier_name', 'contract_terms'],
