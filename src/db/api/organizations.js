...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.human_resources_organizations =
      await organizations.getHuman_resources_organizations({
        transaction,
      });

    output.inventory_organizations =
      await organizations.getInventory_organizations({
        transaction,
      });

    output.machinery_organizations =
      await organizations.getMachinery_organizations({
        transaction,
      });

    output.quality_control_organizations =
      await organizations.getQuality_control_organizations({
        transaction,
      });

    output.raw_materials_organizations =
      await organizations.getRaw_materials_organizations({
        transaction,
      });

    output.suppliers_organizations =
      await organizations.getSuppliers_organizations({
        transaction,
      });

    output.work_orders_organizations =
      await organizations.getWork_orders_organizations({
        transaction,
      });
